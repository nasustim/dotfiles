...
**SHOULD** Before changing code, create a .nasustim-documents/TODO_{task or branch name}.md file and write down your plan for the changes. You have complete to implement all item in the todo list, then remove the todo list.
